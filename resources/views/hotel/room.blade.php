                    ...
                    <div class="row">        	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 side-bar left-side-bar">
                            ...
                            <div class="side-bar-block booking-form-block">
                            	<h2 class="selected-price">$98.00 <span>Small Cruise</span></h2>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="../images/crs-feature-1.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="../images/crs-feature-2.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="../images/crs-feature-3.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="../images/crs-feature-4.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="../images/crs-feature-5.jpg" class="img-responsive" alt="feature-img"/></div>
                                </div><!-- end feature-slider -->
                            	
                                <div class="feature-slider-nav">
                                    <div><img src="../images/crs-feature-thumb-1.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="../images/crs-feature-thumb-2.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="../images/crs-feature-thumb-3.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="../images/crs-feature-thumb-4.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="../images/crs-feature-thumb-5.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                </div><!-- end feature-slider-nav -->
                                
                                <ul class="list-unstyled features tour-features">
                                	<li><div class="f-icon"><i class="fa fa-bed"></i></div><div class="f-text"><p class="f-heading">bed</p><p class="f-data">2</p></div></li>
                            ...
                            <div class="detail-tabs">
                            	<ul class="nav nav-tabs nav-justified">
                                    <li class="active"><a href="#cruise-information" data-toggle="tab">Cruise Information</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="cruise-information" class="tab-pane in active">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="../images/cruise-detail-tab-1.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="crs-features" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="../images/cruise-detail-tab-2.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="cabins" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="../images/cruise-detail-tab-3.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="reviews" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="../images/cruise-detail-tab-4.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                            ...
                            <div class="available-blocks" id="available-tours">
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img crs-list-img">
                                            <a href="cruise-detail-left-sidebar.html">
                                                <img src="../images/cruise-list-1.jpg" class="img-responsive" alt="cruise-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1300<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                                                    <li class="rating">
                                        ...
                                        <div class="list-info crs-list-info">
                                            <h3 class="block-title"><a href="cruise-detail-left-sidebar.html">Belgium to Greek</a></h3>
                                            <p class="block-minor">Include Port Taxes</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="cruise-detail-left-sidebar.html" class="btn btn-orange btn-lg">View More</a>
                                ...
                                <div class="list-block main-block crs-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img crs-list-img">
                                            <a href="cruise-detail-left-sidebar.html">
                                                <img src="../images/cruise-list-2.jpg" class="img-responsive" alt="cruise-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1400<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                                                    <li class="rating">
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                        ...
                                        <div class="list-info crs-list-info">
                                            <h3 class="block-title"><a href="cruise-detail-left-sidebar.html">Italy to Spain </a></h3>
                                            <p class="block-minor">Include Port Taxes</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="cruise-detail-left-sidebar.html" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end crs-list-info -->
                                ...
                                <div class="list-block main-block crs-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img crs-list-img">
                                            <a href="cruise-detail-left-sidebar.html">
                                                <img src="../images/cruise-list-3.jpg" class="img-responsive" alt="cruise-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1120<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                                                    <li class="rating">
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                        ...
                                        <div class="list-info crs-list-info">
                                            <h3 class="block-title"><a href="cruise-detail-left-sidebar.html">Alacati to Istanbul </a></h3>
                                            <p class="block-minor">Include Port Taxes</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="cruise-detail-left-sidebar.html" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end crs-list-info -->
                                ...
                                <div class="list-block main-block crs-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img crs-list-img">
                                            <a href="cruise-detail-left-sidebar.html">
                                                <img src="../images/cruise-list-4.jpg" class="img-responsive" alt="cruise-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1250<span class="divider">|</span><span class="pkg">6 Night, 7 Days</span></li>
                                                    <li class="rating">
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                                        <span><i class="fa fa-star orange"></i></span>
                                        ...
                                        <div class="list-info crs-list-info">
                                            <h3 class="block-title"><a href="cruise-detail-left-sidebar.html">France to Mardin </a></h3>
                                            <p class="block-minor">Include Port Taxes</p>
                                            <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                                            <a href="cruise-detail-left-sidebar.html" class="btn btn-orange btn-lg">View More</a>
                                         </div><!-- end crs-list-info -->
